...
def readEOV(mapSectionNumber):
    """Give back the "down-left" and "upper-right" coordinates of an Hungarian EOV datum section. 
    The section defined by it's section number, eg.: 40-123 or 910-21234"""
    ...
    def getEOVCornerCoords(sectionEOV):
        ...
        print('Y2:',up_riht_y)
        print('X2:',up_right_x)
        cornerCoords = (up_riht_y, up_right_x, down_left_y, down_left_x)            #Tuple!
        return(cornerCoords)
    ...
    if rowColumnList == False or sectionList == False:
        print('The', mapSectionNumber, 'contains incorrect data input.')
    else:
        ...
        getEOVSectionScale(mapSectionNumber,sectionEOV)
        return getEOVCornerCoords(sectionEOV)                                  #Calc the coordinates
